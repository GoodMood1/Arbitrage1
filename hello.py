...
exchanges = [
    ccxt.okx({"apiKey": api1,"secret": apis1}),
    ccxt.bybit({"apiKey": api2,"secret": apis2,"options": {"defaultType": "spot"}}),
    ccxt.binance({"apiKey": api3,"secret": apis3}),
    ccxt.kucoin({"apiKey": api4,"secret": apis4}),
    ccxt.kraken(),
    ccxt.huobi()
]
